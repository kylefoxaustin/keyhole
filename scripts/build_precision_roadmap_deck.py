...
CHARTS = [
    ...
    ("data/output/precision_composition.png",
     "Today's measured INT-vs-FP composition — the anchor",
     "Where the bits actually go, by params / FLOPs / stored bytes"),
    ...
    ("data/output/precision_5090_breadth_v2.png",
     "The asymmetry is architecture-general",
     "9 same-base pairs across 5 architectures — every one ties on decode, splits 3.2–4.5× on prefill"),
