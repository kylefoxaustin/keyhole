...
SLIDES = [
    ...
    ("data/output/precision_5090_breadth_v2.png",
     "Edge AI Use Cases on NPU Silicon", "8 · The asymmetry is architecture-general — 9 models, 5 architectures · Jun 2026"),
    ("data/output/precision_5090_fp4_lifecycle.png",
     "Edge AI Use Cases on NPU Silicon", "9 · FP4 wins inference AND training — the win grows with compute · Jun 2026"),
    ("data/output/precision_5090_fp4_convergence.png",
     "Edge AI Use Cases on NPU Silicon", "10 · FP4 training converges to BF16 quality — fast AND accurate · Jun 2026"),
]
